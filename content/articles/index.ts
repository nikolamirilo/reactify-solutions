...
import SmallLanguageModelsAgents2026Post, {
  meta as smallLanguageModelsAgents2026Meta,
} from "./posts/small-language-models-agents-2026";
...
const posts: PostRegistryEntry[] = [
  ...
  {
    meta: smallLanguageModelsAgents2026Meta,
    Component: SmallLanguageModelsAgents2026Post,
  },
];
