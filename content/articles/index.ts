...
import ReflectionSelfImprovingAiAgents2026Post, {
  meta as reflectionSelfImprovingAiAgents2026Meta,
} from "./posts/reflection-self-improving-ai-agents-2026";
...
const posts: PostRegistryEntry[] = [
  ...
  {
    meta: reflectionSelfImprovingAiAgents2026Meta,
    Component: ReflectionSelfImprovingAiAgents2026Post,
  },
];
