...
import DspyProgrammingLlmsProduction2026Post, {
  meta as dspyProgrammingLlmsProduction2026Meta,
} from "./posts/dspy-programming-llms-production-2026";
...
const posts: PostRegistryEntry[] = [
  ...
  {
    meta: dspyProgrammingLlmsProduction2026Meta,
    Component: DspyProgrammingLlmsProduction2026Post,
  },
];
