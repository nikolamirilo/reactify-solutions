...
import ComputerUseAgentsProduction2026Post, {
  meta as computerUseAgentsProduction2026Meta,
} from "./posts/computer-use-agents-production-2026";
...
const posts: PostRegistryEntry[] = [
  ...
  {
    meta: computerUseAgentsProduction2026Meta,
    Component: ComputerUseAgentsProduction2026Post,
  },
];
