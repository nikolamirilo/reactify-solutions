...
import GraphRagProduction2026Post, {
  meta as graphRagProduction2026Meta,
} from "./posts/graphrag-production-2026";
...
const posts: PostRegistryEntry[] = [
  ...
  {
    meta: graphRagProduction2026Meta,
    Component: GraphRagProduction2026Post,
  },
];
