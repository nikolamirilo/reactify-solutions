...
import AiAgentGuardrails2026Post, {
  meta as aiAgentGuardrails2026Meta,
} from "./posts/ai-agent-guardrails-2026";
...
const posts: PostRegistryEntry[] = [
  ...
  {
    meta: aiAgentGuardrails2026Meta,
    Component: AiAgentGuardrails2026Post,
  },
];
