...
import Dspy3Production2026Post, {
  meta as dspy3Production2026Meta,
} from "./posts/dspy-3-production-2026";
...
const posts: PostRegistryEntry[] = [
  ...
  {
    meta: dspy3Production2026Meta,
    Component: Dspy3Production2026Post,
  },
];
