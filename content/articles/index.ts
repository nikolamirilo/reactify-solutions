...
import LlamaIndexWorkflowsAgentsProduction2026Post, {
  meta as llamaIndexWorkflowsAgentsProduction2026Meta,
} from "./posts/llamaindex-workflows-agents-production-2026";
...
const posts: PostRegistryEntry[] = [
  ...
  {
    meta: llamaIndexWorkflowsAgentsProduction2026Meta,
    Component: LlamaIndexWorkflowsAgentsProduction2026Post,
  },
];
