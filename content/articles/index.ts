...
import SmallLanguageModelsAiAgents2026Post, {
  meta as smallLanguageModelsAiAgents2026Meta,
} from "./posts/small-language-models-ai-agents-2026";
...
const posts: PostRegistryEntry[] = [
  ...
  {
    meta: smallLanguageModelsAiAgents2026Meta,
    Component: SmallLanguageModelsAiAgents2026Post,
  },
];
