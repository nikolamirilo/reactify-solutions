...
const PHASES: Phase[] = [
  { label: "understanding-of-idea" },
  { label: "research", sub: ["trends-research", "competitors-research", "market-research"] },
  { label: "product-definition" },
  { label: "planning", sub: ["business-requirements", "architecture"] },
...
export default function SkillHierarchyDiagram() {
  return (
    <DiagramFrame label="develop-new-digital-product, three levels deep">
      <div className="flex flex-col items-start gap-3">
        ...
        <div className="ml-2 flex w-full flex-col gap-2 border-l border-darkBorder pl-4 sm:ml-3 sm:pl-5">
          {PHASES.map((phase) => (
