...
import { openHandbookSearch } from "./HandbookSearch";
...
export default function HandbookHeader({ onToggleSidebar, sidebarOpen }: Props) {
  return (
    <header className="sticky top-0 z-40 flex h-[72px] flex-shrink-0 items-center gap-8 border-b border-darkBorder/70 bg-dark/85 px-4 backdrop-blur-md sm:px-6 lg:px-10">
      ...
      <div className="flex flex-grow justify-center">
        ...
        >
          ...
          <span className="flex-grow truncate text-[13px] text-textFaint">Search the handbooks</span>
